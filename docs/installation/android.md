...
Для Android в качестве основного клиента мы рекомендуем использовать v2RayTun. Это надежный и простой в настройке клиент.
...
1. Скопируйте ссылку подписки для Android из нашего [Telegram бота](https://t.me/bez_filtrov_vpn_bot).  
...
4. Нажмите переключатель сверху для соединения. Разрешите добавление VPN-конфигурации, если телефон спросит.
