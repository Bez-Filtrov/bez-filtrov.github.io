...
1. Убедитесь что у вас установлен OpenSSL введя в Powershell команду: `openssl version`.
2. Если вы увидете текст с версией OpenSSL, значит можно перейти к установке программы.
3. Если увидете, ошибку, то вам необходимо установить OpenSSL с помощью команды `winget install FireDaemon.OpenSSL`.
4. После упешной установки перезагрузите компьютер.
